...
export default function AccountantDashboard() {
  ...
  // Debounce search query (Instagram style delay to prevent excessive queries)
  React.useEffect(() => {
                        ...
                        {suggestions.map((s) => {
                          ...
                          return (
                            <button
                              ...
                              className="w-full px-4 py-3 hover:bg-emerald-50/60 text-xs transition-all flex justify-between items-center cursor-pointer group"
                            >
                              <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                          ...
                                          <div className="relative">
                                            <input
                                              ...
                                              className="w-full p-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:outline-none focus:bg-white focus:border-emerald-500 pr-12 shadow-2xs"
                                            />
                                            <button
                                              type="button"
                                              onClick={() => {
                                              ...
                                              className="absolute right-1 top-1.5 bottom-1.5 px-2 bg-emerald-50 hover:bg-emerald-100 text-[8px] font-black text-emerald-700 rounded-lg transition-colors cursor-pointer"
                                            >
                                              FULL
                                            </button>
                                          </div>
